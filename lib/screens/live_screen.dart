...
class _LiveScreenState extends State<LiveScreen> {
  ...
  List<LiveChannel> _filtered(int idx) {
    final cat = _cats[idx];
...
class _CatItemState extends State<_CatItem> {
  ...
  @override
  void dispose() { _focus.removeListener(_onFocus); _focus.dispose(); super.dispose(); }
      ...
      child: Focus(
        ...
        child: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            transform: _focused ? (Matrix4.identity()..scale(1.07)) : Matrix4.identity(),
